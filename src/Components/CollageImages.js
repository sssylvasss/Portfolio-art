...
return (
    <Main>
        ...
        <CollageContainer>
            ...
            <ArtPicsBiggest src="../assets/195Swimming beaver collage.gif" alt="Collage"/> 
        </CollageContainer> 
        <CollageContainer>
            <ArtPicsBigger src="../assets/293master of fine arts and other things.jpg" alt="Collage"/> 
            <ArtPicsBigger src="../assets/292my studio is my cave or he illusion of a solution73x55cm.gif" alt="Collage"/> 
        </CollageContainer> 
        <CollageContainer>  
